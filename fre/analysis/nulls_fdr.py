...
def verify_significance(null_result: Dict[str, any], alpha: float = 0.05) -> Dict[str, Any]:
    """
...
def pairwise_fdr(conditions: Dict[str, np.ndarray], alpha: float = 0.05) -> Dict[str, Any]:
    """
